...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="greetByFullName", path = "greetByFullName", httpMethod = HttpMethod.GET)
    public HelloClass greetByFullName(@Named("name") String name,@Named("surname") String surname,   @Named("period") String period){
